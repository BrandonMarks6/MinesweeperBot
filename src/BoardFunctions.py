...
def run_scanner(box_coords, row_num, col_num):
    curr_board = []
    ...
    while True:
        ...
        scan_board(curr_board, box_coords, row_num, col_num, doDeepScan)
        doDeepScan = False
        ...
        actionNoTakenCount += Rules.run_rules(curr_board)
...
def find_board():
    ...
    for _ in range(10):
        ...
        if board_loc_easy:
            ...
            double_click_middle(board_loc_easy)
            return board_loc_easy, EASY_HEIGHT, EASY_LENGTH
        ...
        if board_loc_medium:
            ...
            double_click_middle(board_loc_medium)
            return board_loc_medium, MEDIUM_HEIGHT, MEDIUM_LENGTH

        board_loc_hard = pyautogui.locateOnScreen(
            "PictureHolder/HardMap.png", confidence=0.9)
        if board_loc_hard:
            print("Hard Board Loacated")
            double_click_middle(board_loc_hard)
            return board_loc_hard, HARD_HEIGHT, HARD_LENGTH
...
def double_click_middle(coords):
...
def populate_board(picture_list, curr_board, box_coords, row_param, col_param):
...
"""
def scan_board(curr_board, box_coords, row_param, col_param, doDeepScan):
    start = time.time()
    print()
    print()
    ...
    if row_param == EASY_HEIGHT and doDeepScan:
        picture_list = {
            "numbers/One.png": "1",
            "numbers/Two.png": "2",
            "numbers/Three.png": "3",
    ...
    if row_param == EASY_HEIGHT and not doDeepScan:
        picture_list = {
            "numbers/One.png": "1",
            "numbers/Two.png": "2",
            "numbers/Three.png": "3",
    ...
    if row_param == MEDIUM_HEIGHT and doDeepScan:
        picture_list = {
    ...
    if row_param == MEDIUM_HEIGHT and not doDeepScan:
        picture_list = {
            "numbers/MedOne.png": "1",
            "numbers/MedTwo.png": "2",
            "numbers/MedThree.png": "3",
    ...
    if row_param == HARD_HEIGHT and doDeepScan:
        picture_list = {
    ...
    if row_param == HARD_HEIGHT and not doDeepScan:
        picture_list = {
            "numbers/HardOne.png": "1",
            "numbers/HardTwo.png": "2",
            "numbers/HardThree.png": "3",
    ...
    populate_board(picture_list, curr_board, box_coords, row_param, col_param)
